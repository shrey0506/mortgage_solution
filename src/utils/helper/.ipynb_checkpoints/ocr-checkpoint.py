...
def text_extract(image_b64, doc_type: str) -> str:
    """
    ...
    try:
        ...
        **You are an intelligent assistant for processing UK mortgage application documents.**
        ...
        client = Client(vertexai=True, project="ltc-reboot25-team-56", location="global")
            ...
            types.Content(
                ...
                parts=[
                    ...
                    types.Part(
                        inline_data=Blob(
                            mime_type=mime_type,
                            data=image_b64  # pass base64 string here
                        )
                    )
                ]
            )
